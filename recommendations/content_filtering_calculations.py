...
# Find communities
partition = community_louvain.best_partition(similarity_graph, resolution=1.6)
...
with open('F:\\TUD\\FYP\\recommendations\\json\\community_partition.json', 'w') as file:
    json.dump(partition, file)

with open('F:\\TUD\\FYP\\recommendations\\json\\community_pagerank_scores.json', 'w') as file:
